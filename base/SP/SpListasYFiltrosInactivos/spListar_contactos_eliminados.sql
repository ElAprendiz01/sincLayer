...
CREATE OR ALTER PROCEDURE Listar_Tbl_Contacto_inactivos
AS
BEGIN
    SET NOCOUNT ON;
    ...
    WHERE e.Estado IN ('Borrado', 'inactivo','eliminado','Eliminado','desactivado')
    ORDER BY c.Id_Contacto DESC;
END;
GO

EXEC Listar_Tbl_Contacto_inactivos;